function clippyCopiedCallback(a) {
    ...
    b.attr("title", "copied!").trigger("tipsy.reload"),
    setTimeout(function() {
...
function defineNetwork(a) {
    var b = function(a, b, c) {
        ...
        this.loaderOffset = 0,
        this.ctx = this.initCanvas(a, b, c),
    ...
    return b.prototype = {
        ...
        startLoader: function(a) {
            ...
            this.ctx.fillText(a, this.width / 2, 85),
            this.ctx.restore();
            var b = this;
        ...
        displayLoader: function() {
            ...
            this.ctx.save(),
            this.ctx.translate(this.width / 2 + .5, 50),
            this.ctx.clearRect( - 16, -16, 32, 32),
            this.ctx.rotate(this.loaderOffset * (Math.PI / 6));
            for (var a = 0; a < 12; a++) this.ctx.fillStyle = colors[a] || "#c4d2e1",
            this.ctx.beginPath(),
        ...
        waitForCurrent: function(b) {
            ...
            a(".js-network-poll").each(function() {
                ...
                a.smartPoller(function(e) {
                    a.getJSON("/cache/network_current/" + d,
                    function(a) {
                        a && a.current ? (console.log("network is current:", a), c.current = !0, b(a)) : (console.log("network is not current, retrying:", a), e())
                    })
                })
            })
        },
        ...
        init: function(a) {
            this.focus = a.focus,
            this.nethash = a.nethash,
            this.spaceMap = a.spacemap,
            this.userBlocks = a.blocks,
            this.commits = [];
            ...
            this.chrome = new b.Chrome(this, this.ctx, this.width, this.height, this.focus, this.commits, this.userBlocks, this.users),
            this.graph = new b.Graph(this, this.ctx, this.width, this.height, this.focus, this.commits, this.users, this.spaceMap, this.userBlocks, this.nethash),
            this.mouseDriver = new b.MouseDriver(this.container, this.chrome, this.graph),
            this.keyDriver = new b.KeyDriver(this.container, this.chrome, this.graph),
            this.stopLoader(),
    ...
    b.Commit.prototype = {
        populate: function(a, b, c) {
            ...
            this.date = Date.parseISO8601(a.date),
            this.gravatar = a.gravatar,
            this.id = a.id,
            this.login = a.login,
            this.message = a.message,
            this.space = a.space,
            this.time = a.time,
            this.parents = this.populateParents(a.parents, c),
            this.requested = !0,
    ...
    b.Chrome = function(a, b, c, d, e, f, g, h) {
        ...
        this.userBlocks = g,
        this.users = h,
        this.offsetX = this.namesWidth + (c - this.namesWidth) / 2 - e * 20,
        this.offsetY = 0,
        this.contentHeight = this.calcContentHeight(),
        this.graphMidpoint = this.namesWidth + (c - this.namesWidth) / 2,
        this.activeUser = null
    },
    b.Chrome.prototype = {
        moveX: function(a) {
            this.offsetX += a,
            this.offsetX > this.graphMidpoint ? this.offsetX = this.graphMidpoint: this.offsetX < this.graphMidpoint - this.commits.length * 20 && (this.offsetX = this.graphMidpoint - this.commits.length * 20)
        },
        moveY: function(a) {
            this.offsetY += a,
        ...
        drawTimeline: function(a) {
            a.fillStyle = "#111111",
            a.fillRect(0, 0, this.width, 20),
            a.fillStyle = "#333333",
            a.fillRect(0, 20, this.width, 20);
            var b = parseInt((0 - this.offsetX) / 20);
            b < 0 && (b = 0);
            var c = b + parseInt(this.width / 20);
            c > this.commits.length && (c = this.commits.length),
            a.save(),
            a.translate(this.offsetX, 0),
            a.font = "10px Helvetica, sans-serif";
            var d = null,
            e = null;
            for (var f = b; f < c; f++) {
        ...
        drawUsers: function(a) {
            a.fillStyle = "#FFFFFF",
            a.fillRect(0, 0, this.namesWidth, this.height),
            a.save(),
            a.translate(0, 40 + this.offsetY);
            for (var b = 0; b < this.userBlocks.length; b++) {
                var c = this.userBlocks[b];
                a.fillStyle = this.userBgColors[b % 2],
                a.fillRect(0, c.start * 20, this.namesWidth, c.count * 20),
                this.activeUser && this.activeUser.name == c.name && (a.fillStyle = "rgba(0, 0, 0, 0.05)", a.fillRect(0, c.start * 20, this.namesWidth, c.count * 20)),
                a.fillStyle = "#DDDDDD",
                a.fillRect(0, c.start * 20, 1, c.count * 20),
                a.fillRect(this.namesWidth - 1, c.start * 20, 1, c.count * 20),
                a.fillRect(this.width - 1, c.start * 20, 1, c.count * 20),
                a.fillRect(0, (c.start + c.count) * 20 - 1, this.namesWidth, 1);
                var d = a.measureText(c.name).width,
                e = (c.start + c.count / 2) * 20 + 3;
                a.fillStyle = "#000000",
                a.font = "12px Monaco, monospace",
                a.textAlign = "center",
                a.fillText(c.name, this.namesWidth / 2, e, 96)
            }
            a.restore(),
            a.fillStyle = "#111111",
            a.fillRect(0, 0, this.namesWidth, 20),
            a.fillStyle = "#333333",
            a.fillRect(0, 20, this.namesWidth, 20)
        },
        drawFooter: function(a) {
            a.fillStyle = "#F4F4F4",
            a.fillRect(0, this.height - 20, this.width, 20),
            a.fillStyle = "#CCCCCC",
            a.fillRect(0, this.height - 20, this.width, 1),
            a.fillStyle = "#000000",
            a.font = "11px Monaco, monospace",
            a.fillText("GitHub Network Graph Viewer v4.0.0", 5, this.height - 5)
        }
    },
    ...
    b.Graph.prototype = {
        ...
        frontSpan: function(a, b) {
            ...
            if (c != null) {
                ...
                return e ? f = e - 1: c + b >= this.commits.length ? f = this.commits.length - 1: f = c + b,
                [c, f]
            }
            return null
        },
        ...
        requestChunk: function(b, c) {
            ...
            function(a) {
                ...
                e.lastHotLoadCenterIndex = this.focus
            })
        },
        importChunk: function(a) {
            for (var b = 0; b < a.commits.length; b++) {
                ...
                for (var f = 0; f < e.parents.length; f++) {
                    var g = e.parents[f];
                    for (var h = g.time + 1; h < e.time; h++) this.connectionMap[h] = this.connectionMap[h] || [],
                    this.connectionMap[h].push(e)
                }
            }
        },
        timeWindow: function() {
        ...
        drawBackground: function() {
            ...
            for (var a = 0; a < this.userBlocks.length; a++) {
                ...
                this.ctx.fillStyle = this.bgColors[a % 2],
                this.ctx.fillRect(0, b.start * 20 - 10, this.width, b.count * 20),
                this.ctx.fillStyle = "#DDDDDD",
                this.ctx.fillRect(0, (b.start + b.count) * 20 - 11, this.width, 1)
            }
            this.ctx.restore()
        },
        drawCommit: function(a) {
            ...
            this.ctx.fillStyle = this.spaceColor(a.space),
            this.ctx.beginPath(),
            this.ctx.arc(b, c, 4, 0, Math.PI * 2, !1),
            this.ctx.fill(),
            this.ctx.stroke()
        },
        drawActiveCommit: function(a) {
            ...
            this.ctx.fillStyle = this.spaceColor(a.space),
            this.ctx.beginPath(),
            this.ctx.arc(b, c, 6, 0, Math.PI * 2, !1),
            this.ctx.fill(),
            this.ctx.stroke()
        },
        drawCommitInfo: function(a) {
            ...
            f = 0,
            g = 0;
            d < this.graphMidpoint ? f = d + 10: f = d - 410,
            e < 40 + (this.height - 40) / 2 ? g = e + 10: g = e - c - 10,
            this.ctx.save(),
            this.ctx.translate(f, g),
            ...
            this.ctx.lineTo(400, c - 5),
            this.ctx.quadraticCurveTo(400, c, 395, c),
            this.ctx.lineTo(5, c),
            this.ctx.quadraticCurveTo(0, c, 0, c - 5),
            this.ctx.lineTo(0, 5),
            this.ctx.fill(),
            this.ctx.stroke();
            ...
            if (h) this.drawGravatar(h, 10, 10);
                ...
                h = new Image,
                h.src = "https://secure.gravatar.com/avatar/" + a.gravatar + "?s=32&d=https%3A%2F%2Fgithub.com%2Fimages%2Fgravatars%2Fgravatar-32.png",
                h.onload = function() {
            ...
            this.ctx.fillText(a.author, 55, 32),
            this.ctx.fillStyle = "#888888",
            this.ctx.font = "12px Monaco, monospace",
            this.ctx.fillText(a.id, 12, 65),
            this.drawMessage(b, 12, 85),
            this.ctx.restore()
        },
        drawGravatar: function(a, b, c) {
            ...
            this.ctx.beginPath(),
            this.ctx.strokeRect(b + .5, c + .5, 35, 35),
            this.ctx.drawImage(a, b + 2, c + 2)
        },
        ...
        drawHead: function(a, b, c) {
            ...
            this.ctx.translate(e, f),
            this.ctx.fillStyle = "rgba(0, 0, 0, 0.8)",
            this.ctx.beginPath(),
            this.ctx.moveTo(0, 0),
            this.ctx.lineTo( - 4, 10),
            this.ctx.quadraticCurveTo( - 9, 10, -9, 15),
            this.ctx.lineTo( - 9, 15 + d),
            this.ctx.quadraticCurveTo( - 9, 15 + d + 5, -4, 15 + d + 5),
            this.ctx.lineTo(4, 15 + d + 5),
            this.ctx.quadraticCurveTo(9, 15 + d + 5, 9, 15 + d),
        ...
        drawBasicConnection: function(a, b) {
            ...
            this.ctx.lineWidth = 2,
            this.ctx.beginPath(),
            this.ctx.moveTo(a.time * 20, b.space * 20),
            this.ctx.lineTo(b.time * 20, b.space * 20),
            this.ctx.stroke()
        },
        drawBranchConnection: function(a, b) {
            ...
            this.ctx.lineTo(a.time * 20, b.space * 20),
            this.ctx.lineTo(b.time * 20 - 14, b.space * 20),
            this.ctx.stroke(),
            this.threeClockArrow(c, b.time * 20, b.space * 20)
        },
        drawMergeConnection: function(a, b) {
            ...
            if (a.space > b.space) {
                ...
                if (d) this.ctx.lineTo(b.time * 20 - 10, a.space * 20),
                this.ctx.lineTo(b.time * 20 - 10, b.space * 20 + 15),
                this.ctx.lineTo(b.time * 20 - 7.7, b.space * 20 + 9.5),
                this.ctx.stroke(),
                this.oneClockArrow(c, b.time * 20, b.space * 20);
                else {
        ...
        addMargin: function(a, b, c) {
            var d = c;
            this.marginMap[d] || (this.marginMap[d] = []),
            this.marginMap[d].push([a, b])
        },
        oneClockArrow: function(a, b, c) {
            this.ctx.fillStyle = a,
            this.ctx.beginPath(),
            this.ctx.moveTo(b - 6.3, c + 13.1),
            this.ctx.lineTo(b - 10.8, c + 9.7),
            this.ctx.lineTo(b - 2.6, c + 3.5),
            this.ctx.fill()
        },
        twoClockArrow: function(a, b, c) {
            this.ctx.fillStyle = a,
            this.ctx.beginPath(),
            this.ctx.moveTo(b - 12.4, c + 6.6),
            this.ctx.lineTo(b - 9.3, c + 10.6),
            this.ctx.lineTo(b - 3.2, c + 2.4),
            this.ctx.fill()
        },
        threeClockArrow: function(a, b, c) {
            this.ctx.fillStyle = a,
            this.ctx.beginPath(),
            this.ctx.moveTo(b - 14, c - 2.5),
            this.ctx.lineTo(b - 14, c + 2.5),
            this.ctx.lineTo(b - 4, c),
            this.ctx.fill()
        },
        ...
        closestMargin: function(a, b, c, d) {
            ...
            while (!h || !g) {
                ...
                c + f < 0 && (g = !0),
                c + f > e && (h = !0),
                i == 0 && f == 0 ? (f = -1, i = !0) : f < 0 ? f = -f - 1: f = -f - 2
            }
            return c > 0 ? c - 1: 0
        },
    ...
    b.MouseDriver = function(b, c, d) {
        ...
        this.up = function(a) {
            g.dragging = !1,
            g.pressedCommit && g.graph.activeCommit == g.pressedCommit ? window.open("/" + g.graph.activeCommit.user.name + "/" + g.graph.activeCommit.user.repo + "/commit/" + g.graph.activeCommit.id) : g.pressedUser && g.chrome.activeUser == g.pressedUser && (window.location = "/" + g.chrome.activeUser.name + "/" + g.chrome.activeUser.repo + "/network"),
        ...
        this.docmove = function(a) {
            var b = a.pageX,
            c = a.pageY;
            g.dragging && (g.graph.moveX(b - g.lastPoint.x), g.graph.moveY(c - g.lastPoint.y), g.graph.draw(), g.chrome.moveX(b - g.lastPoint.x), g.chrome.moveY(c - g.lastPoint.y), g.chrome.draw()),
            g.lastPoint.x = b,
            g.lastPoint.y = c
        },
        this.move = function(a) {
            var b = a.pageX,
            c = a.pageY;
            if (g.dragging) g.graph.moveX(b - g.lastPoint.x),
            g.graph.moveY(c - g.lastPoint.y),
            g.graph.draw(),
            g.chrome.moveX(b - g.lastPoint.x),
            g.chrome.moveY(c - g.lastPoint.y),
            g.chrome.draw();
            else {
                var d = g.chrome.hover(b - a.target.offsetLeft, c - a.target.offsetTop);
                if (d != g.lastHoverUser) d ? f.style.cursor = "pointer": f.style.cursor = "move",
                g.chrome.activeUser = d,
                g.chrome.draw(),
                g.lastHoverUser = d;
                else {
        ...
        a("body")[0].onmousemove = this.docmove,
    ...
    b.KeyDriver = function(b, c, d) {
        ...
        this.press = function(b) { (a.browser.mozilla || a.browser.opera) && e.down({
                shiftKey: !1,
                which: b.keyCode
            })
        },
    ...
    window.onerror = function(a, c, d) {
        ...
        (f = window.errors) == null && (window.errors = []),
...
window.Modernizr = function(a, b, c) {
    ...
    y = function() {
        function d(d, e) {
            ...
            d = "on" + d;
            var f = d in e;
            return f || (e.setAttribute || (e = b.createElement("div")), e.setAttribute && e.removeAttribute && (e.setAttribute(d, ""), f = D(e[d], "function"), D(e[d], "undefined") || (e[d] = c), e.removeAttribute(d))),
            e = null,
            f
        }
        var a = {
    ...
    var H = function(c, d) {
        ...
        function(c, d) {
            ...
            e.touch = "ontouchstart" in a || (j.touch && j.touch.offsetTop) === 9,
    ...
    r.rgba = function() {
        ...
        E(k.backgroundColor, "rgba")
    },
    r.hsla = function() {
        return B("background-color:hsla(120,40%,100%,.5)"),
        E(k.backgroundColor, "rgba") || E(k.backgroundColor, "hsla")
    },
    ...
    function(a, b) {
        ...
        d.getCSS = function(a, b) {
            ...
            while (++f < g) {
                ...
                b = h.media || b,
                q.test(b) && i.push(d.getCSS(h.imports, b), h.cssText),
                b = "all"
            }
            return i.join("")
        },
...
$(document).bind("ajaxBeforeSend",
function(a, b, c) {
    if (!c.dataType) return b.setRequestHeader("Accept", "*/*;q=0.5, " + c.accepts.script)
}),
$(document).delegate("a[data-confirm]", "click",
function(a) {
    var b;
    if (b = $(this).attr("data-confirm")) if (!confirm(b)) return a.stopImmediatePropagation(),
    !1
}),
$(document).bind("ajaxBeforeSend",
function(a, b, c) {
...
function(a) {
    ...
    if (b.attr("method").toUpperCase() === "GET") return;
    d = $('meta[name="csrf-param"]').attr("content"),
    e = $('meta[name="csrf-token"]').attr("content"),
    d != null && e != null && (b.find("input[name=" + d + "]")[0] || (c = document.createElement("input"), c.setAttribute("type", "hidden"), c.setAttribute("name", d), c.setAttribute("value", e), b.prepend(c)))
}),
$(document).delegate("form", "submit",
function() {
    var a,
    ...
    for (d = 0, f = h.length; d < f; d++) b = h[d],
    b = $(b),
...
$(document).delegate("a[data-remote]", "click",
function(a) {
    var b,
    c,
    d,
...
$(document).delegate("form[data-remote]", "submit",
function(a) {
    var b,
    c,
    d,
...
function() {
    if (window.CanvasRenderingContext2D && CanvasRenderingContext2D.prototype.getImageData) {
        ...
        CanvasRenderingContext2D.prototype.blendOnto = function(b, c, d) {
            var e = {};
            for (var f in a) a.hasOwnProperty(f) && (e[f] = d && d[f] || a[f]);
        ...
        for (var d = 0, e = b.length; d < e; ++d) c[b[d]] = !0
    }
} (),
function(a) {
    a.fn.extend({
    ...
    a.Autocompleter = function(b, c) {
        function n() {
            ...
            if (c.multiple) {
                ...
                if (h.length > 1) {
                    ...
                    h[k] = f,
                    f = h.join(c.multipleSeparator)
                }
                f += c.multipleSeparator
            }
            return e.val(f),
            v(),
            e.trigger("result", [d.data, d.value]),
            !0
        }
        function o(a, b) {
            if (j == d.DEL) {
            ...
            g = f,
            f = q(f),
            f.length >= c.minChars ? (e.addClass(c.loadingClass), c.matchCase || (f = f.toLowerCase()), x(f, w, v)) : (z(), l.hide())
        }
        function p(b) {
            return b ? c.multiple ? a.map(b.split(c.multipleSeparator),
            function(c) {
        ...
        function q(d) {
            ...
            return f == d.length ? e = p(d) : e = p(d.replace(d.substring(f), "")),
            e[e.length - 1]
        }
        function r(f, h) {
        ...
        function v() {
            ...
            clearTimeout(f),
            z(),
            c.mustMatch && e.search(function(a) {
                if (!a) if (c.multiple) {
        ...
        function(b) {
            ...
            case d.UP:
                b.preventDefault(),
                l.visible() ? l.prev() : o(0, !0);
                break;
            case d.DOWN:
                b.preventDefault(),
                l.visible() ? l.next() : o(0, !0);
                break;
            case d.PAGEUP:
                b.preventDefault(),
                l.visible() ? l.pageUp() : o(0, !0);
                break;
            case d.PAGEDOWN:
                b.preventDefault(),
                l.visible() ? l.pageDown() : o(0, !0);
                break;
    ...
    a.Autocompleter.Cache = function(b) {
        function e(a, c) {
            ...
            var d = a.indexOf(c);
            return b.matchContains == "word" && (d = a.toLowerCase().search("\\b" + c.toLowerCase())),
            d == -1 ? !1: d == 0 || b.matchContains
        }
        function f(a, e) {
            d > b.cacheLength && h(),
            c[a] || d++,
    ...
    a.Autocompleter.Select = function(b, c, d, e) {
        function n() {
            ...
            m = a("<ul/>").appendTo(l).mouseover(function(b) {
                ...
                return a(o(b)).addClass(f.ACTIVE),
                d(),
                c.focus(),
                !1
            }).mousedown(function() {
        ...
        function s() {
            ...
            g = m.find("li"),
            b.selectFirst && (g.slice(0, 1).addClass(f.ACTIVE), h = 0),
            ...
            show: function() {
                ...
                if (b.scroll) {
                    ...
                    if (a.browser.msie && typeof document.body.style.maxHeight == "undefined") {
                        ...
                        f || g.width(m.width() - parseInt(g.css("padding-left")) - parseInt(g.css("padding-right")))
                    }
                }
            },
            selected: function() {
        ...
        return this.each(function() {
            ...
            k = function(d) {
                ...
                a.ajax({
                    ...
                    error: function() {
                        e.stopSpin(),
                        b.attr("data-reset-on-error") && e.val(j),
                        f.show()
                    }
                })
            };
...
function(a) {
    ...
    function k() {
        if (i()) return;
        return a("#facebox_overlay").fadeOut(200,
        function() {
...
jQuery._farbtastic = function(a, b) {
    ...
    c.linkTo = function(a) {
        ...
        else if (typeof a == "object" || typeof a == "string") c.callback = $(a),
...
function($) {
    function clickHandler(a) {
        var b = this.form;
        b.clk = this;
        if (this.type == "image") if (a.offsetX != undefined) b.clk_x = a.offsetX,
        b.clk_y = a.offsetY;
        else if (typeof $.fn.offset == "function") {
            var c = $(this).offset();
            b.clk_x = a.pageX - c.left,
            b.clk_y = a.pageY - c.top
        } else b.clk_x = a.pageX - this.offsetLeft,
...
function(a) {
    a.fn.assigneeFilter = function(b) {
        ...
        return c.find(".js-assignee-filter-submit").live("click",
        function(a) {
            b(a),
            a.preventDefault()
        }),
        c.find(".js-assignee-filter").keydown(function(a) {
            ...
            case 38:
            case 40:
                if (g.length == 0) return f(c.find("li:visible:first")),
                !1;
                return h = b.which == 38 ? g.prevAll(":visible:first") : g.nextAll(":visible:first"),
                h.length && f(h),
                !1
            }
            var i = a.trim(a(this).val().toLowerCase()),
            j = [];
            if (!i) return c.find(".current").removeClass("current"),
            d.show();
            d.hide(),
            e.each(function(a) {
                var b = this.score(i);
...
$.fn.contextButton = function(a, b) {
    return $(this).delegate(a, "click",
    function(a) {
        var c = $(this),
        d = $.extend({
        ...
        f = function() {
            ...
            e.trigger("deactivated.contextPane")
        };
        if (e.is(":visible")) f();
        else {
            var g = c.offset(),
            ...
            $("#context-overlay").click(f).css("position", "fixed").css("top", 0).css("left", 0).css("height", "100%").css("width", "100%"),
            e.show(),
            setTimeout(function() {
                e.addClass("active")
            },
            50),
            e.trigger("activated.contextPane"),
            c.addClass("selected"),
            c.trigger("show.context-button")
        }
        e.find("a.close").live("click", f),
        e.bind("close.context-button", f)
    })
},
$(document).contextButton(".js-context-button"),
function(a) {
    function b(a) {
        var b = a.toString(10);
    ...
    a.strftime = function(a, g) {
        ...
        j = a.getHours(),
        k = a.getMinutes();
        return g.replace(/\%([aAbBcdHImMpSwyY])/g,
        function(g) {
            switch (g.substr(1, 1)) {
            case "a":
                return c[h];
...
function(a) {
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        _mouseDrag: function(b, c) {
            ...
            if (!c) {
                c = this._uiHash();
                if (this._trigger("drag", b, c) === !1) return this._mouseUp({}),
                !1;
    ...
    a.widget("ui.droppable", {
        ...
        _drop: function(b, c) {
            ...
            return this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function() {
                ...
                }), b.options.tolerance)) return f = !0,
                !1
            }),
...
function(a) {
    a.fn.editableComment = function() {
        a(this).delegate(".comment .edit-button", "click",
        function(b) {
            var c = a(this).closest(".comment");
            return c.addClass("editing"),
            !1
        }),
        a(this).delegate(".comment .delete-button", "click",
        function(b) {
            var c = a(this).closest(".comment"),
        ...
        a(this).delegate(".comment .cancel", "click",
        function() {
            return a(this).closest(".comment").removeClass("editing"),
            !1
        }),
        a(this).delegate(".comment .form-content form", "submit",
        function() {
...
function(a) {
    a.fn.enticeToAction = function(b) {
        var c = a.extend({},
        a.fn.enticeToAction.defaults, b);
        return this.each(function() {
            var b = a(this);
            b.addClass("entice"),
...
function(a) {
    a.fn.previewableCommentForm = function(b) {
        var c = a.extend({},
        a.fn.previewableCommentForm.defaults, b);
        return this.each(function() {
            var b = a(this);
...
function(a) {
    a.fn.redirector = function(b) {
        var c = a.extend({},
        a.fn.redirector.defaults, b);
        if (this.length == 0) return;
        a.smartPoller(c.time,
        function(b) {
            a.getJSON(c.url,
            function(a) {
...
$.fn.selectableList = function(a, b) {
    return $(this).each(function() {
        ...
        b);
        return c.delegate(a + " " + d.itemParentSelector + " " + d.wrapperSelector, "click",
        function(b) {
        ...
        c.delegate(a + " li :checkbox," + a + " li :radio", "change",
        function(b) {
            var e = $(this),
...
$.fn.sortableHeader = function(a, b) {
    return $(this).each(function() {
        ...
        b);
        c.delegate(a + " " + d.itemSelector, "click",
        function(a) {
            a.preventDefault();
            var b = $(this);
...
function() {
    ...
    Modernizr.hashchange || (a = window.location.hash, setInterval(function() {
        if (window.location.hash !== a) return a = window.location.hash,
...
function() {
    ...
    b = function(a) {
        ...
        c,
        e;
        return a.type === "keypress" ? b = String.fromCharCode(a.which) : b = d[a.which],
        c = "",
        a.ctrlKey && b !== "ctrl" && (c += "ctrl+"),
        a.altKey && b !== "alt" && (c += "alt+"),
        a.metaKey && !a.ctrlKey && b !== "meta" && (c += "meta+"),
        a.shiftKey ? a.type === "keypress" ? "" + c + b: (e = f[a.which]) ? "" + c + e: b === "shift" ? "" + c + "shift": b ? "" + c + "shift+" + b: null: b ? "" + c + b: null
    },
    i = ["keydown", "keyup", "keypress"];
    ...
    a.event.special[e] = {
        add: function(a) {
            ...
            a.handler = function(a) {
                var d;
                return (d = a.hotkey) == null && (a.hotkey = b(a)),
    ...
    function(b) {
        ...
        if (d = c[b.hotkey]) return d.apply(this, arguments)
    }),
    a.hotkeys = function(b) {
        var c,
        d;
        for (c in b) d = b[c],
        a.hotkey(c, d);
...
function($) {
    $.fn.editable = function(a, b) {
        ...
        function() {},
        e = $.editable.types[c.type].submit ||
        function() {},
...
function(a) {
    ...
    function(b) {
        b.preventDefault();
        var c = a(this),
        d = c.attr("data-afterclick") || "Loading鈥�";
...
function(a) {
    ...
    a.pjax = function(b) {
        ...
        var e = {
            ...
            success: function(e) {
                ...
                i = a.param(b.data);
                i != "_pjax=true" && (h.url = b.url + (/\?/.test(b.url) ? "&": "?") + i),
                b.replace ? window.history.replaceState(h, document.title, b.url) : b.push && (a.pjax.active || (window.history.replaceState(a.extend({},
                h, {
                    url: null
                }), f), a.pjax.active = !0), window.history.pushState(h, document.title, b.url)),
                (b.replace || b.push) && window._gaq && _gaq.push(["_trackPageview"]);
                var j = window.location.hash.toString();
                j !== "" && (window.location.hash = "", window.location.hash = j),
        ...
        var f = a.pjax.xhr;
        return f && f.readyState < 4 && (f.onreadystatechange = a.noop, f.abort()),
        a.pjax.xhr = a.ajax(b),
        a(document).trigger("pjax", a.pjax.xhr, b),
        a.pjax.xhr
    };
    var b = "state" in window.history,
    c = location.href;
    a(window).bind("popstate",
    function(d) {
    ...
    a.support.pjax = window.history && window.history.pushState,
...
function(a) {
    ...
    a.fn.quicksearch = function(c) {
        ...
        return d.results.delegate("a", "mouseover",
        function(b) {
            var c = a(this);
        ...
        this.each(function() {
            function f() {
                d.insertSpinner && (d.spinner.parent().length || d.insertSpinner.call(c, d.spinner), d.spinner.show()),
                c.trigger("quicksearch.loading"),
                d.loading && e(d.loading.html())
            }
            function g() {
                d.insertSpinner && d.spinner.hide(),
                c.trigger("quicksearch.loaded")
            }
            var c = a(this);
            c.autocompleteField({
            ...
            function(c) {
                ...
                case "enter":
                    var e,
                    f = d.results.find("a.selected");
                    if (f.length) return a(this).blur(),
                    f.hasClass("initial") ? f.closest("form").submit() : window.location = f.attr("href"),
                    !1;
...
function(a) {
    a.put = function(a, b, c, d) {
        var e = null;
        return jQuery.isFunction(b) && (c = b, b = {}),
        jQuery.isPlainObject(c) && (e = c.error, c = c.success),
        jQuery.ajax({
            type: "PUT",
            url: a,
            data: b,
    ...
    return this.each(function() {
        ...
        $(this).find("li a").each(function() {
            ...
            $(this).click(function() {
                ...
                e = function() {
                    d && d.hide(),
                    c && c.removeClass("selected"),
                    c = a.addClass("selected"),
                    d = b.show().trigger("tabChanged", {
                        link: c
                    })
                };
    ...
    var b = function() {
        ...
        return {
            getSelectionRange: function(b) {
                ...
                h;
                b.focus();
                if (typeof b.selectionStart != "undefined") c = b.selectionStart,
                d = b.selectionEnd;
                else {
                    ...
                    b.type === "textarea" ? (g = e.duplicate(), g.moveToElementText(b), g.setEndPoint("EndToEnd", e), c = g.text.length - f) : (h = b.createTextRange(), h.setEndPoint("EndToStart", e), c = h.text.length),
                    d = c + f
                }
                return {
                    start: c,
            ...
            insertText: function(a, b, c, d, e) {
                ...
                i = a.value.substr(d);
                a.value = h + b + i,
                e === !0 ? this.setSelectionRange(a, c, g) : this.setSelectionRange(a, g)
            },
...
function() {
    ...
    c;
    a = jQuery,
    a.fn.selectionEndPosition = function() {
        return b(this[0])
    },
    c = ["height", "width", "padding-top", "padding-right", "padding-bottom", "padding-left", "lineHeight", "textDecoration", "letterSpacing", "font-family", "font-size", "font-style", "font-variant", "font-weight"],
    b = function(b) {
        var d,
        e,
        f,
        ...
        i,
        j;
        b == null && (b = document.activeElement);
        if (!a(b).is("textarea")) return;
        if (b.selectionEnd == null) return;
        h = {
            position: "absolute",
            overflow: "auto",
        ...
        for (i = 0, j = c.length; i < j; i++) f = c[i],
        h[f] = a(b).css(f);
        return d = document.createElement("div"),
        a(d).css(h),
        a(b).after(d),
        d.textContent = b.value.substring(0, b.selectionEnd),
    ...
    a.fn.tipsy = function(b) {
        ...
        a(this).hover(function() {
            ...
            c || (c = a('<div class="tipsy"><div class="tipsy-inner"/></div>'), c.css({
                position: "absolute",
                zIndex: 1e5
            }), a.data(this, "active.tipsy", c)),
            (a(this).attr("title") || !a(this).attr("original-title")) && a(this).attr("original-title", a(this).attr("title") || "").removeAttr("title");
            var d;
            typeof b.title == "string" ? d = a(this).attr(b.title == "title" ? "original-title": b.title) : typeof b.title == "function" && (d = b.title.call(this)),
            c.find(".tipsy-inner").html(d || b.fallback);
            var e = a.extend({},
            a(this).offset(), {
...
function(a) {
    ...
    a(document).ready(function() {
        ...
        function(a) {
            var b = Date.now(),
            f = b - (c.last || b);
            c.target = e(a.originalEvent.touches[0].target),
            d && clearTimeout(d),
            c.x1 = a.originalEvent.touches[0].pageX,
            f > 0 && f <= 250 && (c.isDoubleTap = !0),
            c.last = b
        }).bind("touchmove",
        function(a) {
...
jQuery.fn.truncate = function(a, b) {
    function e(a) {
    ...
    return this.each(function() {
        ...
        if (g.length > a) {
            ...
            if (f.search(h) != -1) {
                var m = 0;
                for (eachEl in j) g = [g.substring(0, eachEl), j[eachEl], g.substring(eachEl, g.length)].join(""),
                eachEl < g.length && (m = g.length);
                d.html([g.substring(0, m), g.substring(m, g.length).replace(/<(\w+)[^>]*>.*<\/\1>/gim, "").replace(/<(br|hr|img|input)[^<>]*\/?>/gim, "")].join(""))
            } else d.html(g);
            c[k] = f,
            d.html(["<div class='truncate_less'>", d.html(), b.trail[0], "</div>"].join("")).find(".truncate_show", this).click(function() {
                return d.find(".truncate_more").length == 0 && d.append(["<div class='truncate_more' style='display: none;'>", c[k], b.trail[1], "</div>"].join("")).find(".truncate_hide").click(function() {
                    return d.find(".truncate_more").css("background", "#fff").fadeOut("normal",
                    function() {
                        d.find(".truncate_less").css("background", "#fff").fadeIn("normal",
                        function() {
                            e(this),
                ...
                d.find(".truncate_less").fadeOut("normal",
                function() {
                    d.find(".truncate_more").fadeIn("normal",
                    function() {
                        e(this)
                    }),
                    e(this)
                ...
                jQuery(".truncate_show", d).click(function() {
                    return d.find(".truncate_less").css("background", "#fff").fadeOut("normal",
                    function() {
                        d.find(".truncate_more").css("background", "#fff").fadeIn("normal",
                        function() {
                            e(this),
                            $(this).css("background", "none")
                        }),
...
function(a) {
    ...
    function p(b) {
        ...
        if (o()) {
            ...
            f = e.x,
            g = e.y;
            l.xArray.length >= 5 && l.xArray.shift(),
            l.yArray.length >= 5 && l.yArray.shift(),
            l.xArray.push(f),
            l.yArray.push(g),
            l.xMotion = Math.round((n(l.xArray) - m(l.xArray)) * 1e3) / 1e3,
            l.yMotion = Math.round((n(l.yArray) - m(l.yArray)) * 1e3) / 1e3,
            (l.xMotion > 1.5 || l.yMotion > 1.5) && i != 10 && (i = 10),
            l.xMotion > j || l.yMotion > j ? k++:k = 0,
            k >= 5 ? (h = !0, a(document).unbind("mousemove.plax"), a(window).bind("devicemotion", q(b))) : (h = !1, a(window).unbind("devicemotion"), a(document).bind("mousemove.plax",
            function(a) {
                q(a)
            }))
        }
    ...
    function q(a) {
        ...
        q,
        k;
        for (k = e.length; k--;) q = e[k],
        q.invert != 1 ? q.obj.css("left", q.startX + q.xRange * o).css("top", q.startY + q.yRange * p) : q.obj.css("left", q.startX - q.xRange * o).css("top", q.startY - q.yRange * p)
    }
    var b = 25,
    c = 1 / b * 1e3,
    d = (new Date).getTime(),
    ...
    a.fn.plaxify = function(b) {
        return this.each(function() {
            ...
            c.obj = a(this),
            c.startX = this.offsetLeft,
            c.startY = this.offsetTop,
            c.invert == 0 ? (c.startX -= Math.floor(c.xRange / 2), c.startY -= Math.floor(c.yRange / 2)) : (c.startX += Math.floor(c.xRange / 2), c.startY += Math.floor(c.yRange / 2)),
            e.push(c)
        })
    };
    var m = function(a) {
    ...
    a.plax = {
        enable: function() {
            a(document).bind("mousemove.plax",
            function(a) {
                q(a)
            }),
        ...
        disable: function() {
            a(document).unbind("mousemove.plax"),
...
String.prototype.score = function(a, b) {
    ...
    for (var k = 0, l, m, n, o, p, q; k < d; ++k) {
        n = a[k],
        o = e.indexOf(n.toLowerCase()),
        p = e.indexOf(n.toUpperCase()),
        q = Math.min(o, p),
        m = q > -1 ? q: Math.max(o, p);
        if (m === -1) {
            if (b) {
                i += 1 - b;
                break
...
window.GitHub.debug = !1,
window.debug = function() {},
navigator.userAgent.match("Propane") || top != window && (top.location.replace(document.location), alert("For security reasons, framing is not allowed.")),
...
$(function() {
    function c() {
        $("#facebox .shortcuts:visible").length ? $.facebox.close() : ($(document).one("reveal.facebox",
        function() {
    ...
    $(".tooltipped").each(function() {
        ...
        b = a.hasClass("rightwards") ? "w": b,
        b = a.hasClass("leftwards") ? "e": b,
        a.tipsy({
            gravity: b
        })
    }),
    $(".toggle_link").click(function() {
        return $($(this).attr("href")).toggle(),
        !1
    }),
    $(".hide_alert").live("click",
    function() {
        return $("#site_alert").slideUp(),
    ...
    $(".hide_div").click(function() {
        return $(this).parents("div:first").fadeOut(),
        !1
    });
    var b = $("#login_field");
    b.val() ? b.length && $("#password").focus() : b.focus(),
...
function(a, b, c, d) {
    ...
    return debug("AJAX Error", d),
    $(document.documentElement).addClass("ajax-error")
}),
$(document).on("ajaxBeforeSend", "[data-remote]",
function(a, b, c) {
    return $(document.documentElement).removeClass("ajax-error")
}),
$(document).on("click", ".ajax-error-dismiss",
function() {
    return $(document.documentElement).removeClass("ajax-error"),
    !1
}),
function() {
    ...
    c,
    d,
    e; (e = window._gaq) == null && (window._gaq = []),
    _gaq.push(["_setAccount", "UA-3769691-2"]),
    _gaq.push(["_setDomainName", "none"]),
    _gaq.push(["_trackPageview"]),
    _gaq.push(["_trackPageLoadTime"]),
    document.title === "404 - GitHub" && (d = document.location.pathname + document.location.search, a = document.referrer, _gaq.push(["_trackPageview", "/404.html?page=" + d + "&from=" + a])),
    b = document.createElement("script"),
    b.type = "text/javascript",
    b.async = !0,
    c = document.location.protocol === "https:" ? "https://ssl": "http://www",
    b.src = "" + c + ".google-analytics.com/ga.js",
...
GitHub.Autocomplete.prototype = {
    ...
    repos: function(a) {
        ...
        var b = a.autocomplete(this.reposURL, $.extend({
            ...
            formatItem: function(a) {
                ...
                var b = a[0],
                c = a[1];
                return GitHub.Autocomplete.visibilities[b] = c,
                b
            },
        ...
        this.settings));
        return GitHub.Autocomplete.acceptable(b),
        b
    },
    myRepos: function(a) {
        return a = $(a),
        !$.fn.autocomplete || a.length == 0 ? a: $(document.body).hasClass("logged_in") ? a.autocomplete(this.myReposURL, $.extend({
            delay: 10,
            width: 210,
            selectFirst: !1,
            formatItem: function(a) {
        ...
        this.settings)).result(function(a, b, c) {
            return window.location = "/" + b[0].split(" ")[0],
            !1
        }).keydown(function(b) {
    ...
    users: function(a) {
        ...
        var b = a.autocomplete(this.usersURL, $.extend({
            ...
            formatItem: function(a) {
                ...
                return GitHub.Autocomplete.gravatars[b] = c,
                c + " " + b
            },
            formatResult: function(a) {
                return a[0].split(" ")[0]
    ...
    branches: function(a, b) {
        ...
        return GitHub.Autocomplete.acceptable(c),
        c
    }
},
...
function() {
    ...
    GitHub.DetailsBehavior = function() {
        function b() {
            this.onToggle = a(this.onToggle, this),
            this.onClick = a(this.onClick, this),
            $(document).on("click", ".js-details-container .js-details-target", this.onClick),
            $(document).on("toggle.details", ".js-details-container", this.onToggle)
        }
...
function() {
    ...
    function(a) {
        for (var c = 0, d = this.length; c < d; c++) if (b.call(this, c) && this[c] === a) return c;
        return - 1
    };
    GitHub.MenuBehavior = function() {
        function b() {
            this.onDeactivate = a(this.onDeactivate, this),
            this.onActivate = a(this.onActivate, this),
            this.onClose = a(this.onClose, this),
            this.onContainerClick = a(this.onContainerClick, this),
            this.onKeyDown = a(this.onKeyDown, this),
            this.onClick = a(this.onClick, this),
            $(document).on("click", this.onClick),
            $(document).on("keydown", this.onKeyDown),
            $(document).on("click", ".js-menu-container", this.onContainerClick),
            $(document).on("click", ".js-menu-container .js-menu-close", this.onClose),
            $(document).on("menu:activate", ".js-menu-container", this.onActivate),
            $(document).on("menu:deactivate", ".js-menu-container", this.onDeactivate)
        }
        return b.prototype.onClick = function(a) {
        ...
        b.prototype.onKeyDown = function(a) {
            var b;
            if (!this.activeContainer) return;
            if (a.keyCode === 27) return (b = this.activeContainer, c.call($(document.activeElement).parents(), b) >= 0) && document.activeElement.blur(),
            $(this.activeContainer).trigger("menu:deactivate")
        },
...
function() {
    ...
    a = function() {
        function a() {
            this.onFocus = b(this.onFocus, this),
            this.onDeactivate = b(this.onDeactivate, this),
            this.onActivate = b(this.onActivate, this),
            this.onClick = b(this.onClick, this),
            this.onMouseOver = b(this.onMouseOver, this),
            this.onContainerKeyDown = b(this.onContainerKeyDown, this),
            this.onItemKeyDown = b(this.onItemKeyDown, this),
            this.onKeyDown = b(this.onKeyDown, this);
            var a;
            $(document).on("keydown", this.onKeyDown),
            a = "#js-active-navigation-container:not([data-navigation-no-mouse]) .js-navigation-item",
            $(document).on("mouseover", a, this.onMouseOver),
            $(document).on("click", "" + a + ".js-navigation-target, " + a + " .js-navigation-target", this.onClick),
            $(document).on("navigation:activate", ".js-navigation-container", this.onActivate),
            $(document).on("navigation:deactivate", ".js-navigation-container", this.onDeactivate),
            $(document).on("navigation:focus", ".js-navigation-container", this.onFocus),
            $(document).on("navigation:keydown", "#js-active-navigation-container .js-navigation-item", this.onItemKeyDown),
            $(document).on("navigation:keydown", "#js-active-navigation-container", this.onContainerKeyDown)
        }
        return a.prototype.ctrlBindings = navigator.userAgent.match(/Macintosh/),
        a.prototype.onKeyDown = function(a) {
            var b,
            c,
            d;
            if (! (b = this.getActiveContainer())) return;
            if ($(a.target).is(!$(a.target).is(".js-navigation-enable"))) return;
            return c = $.Event("navigation:keydown"),
            d = $(b).find(".js-navigation-item.navigation-focus")[0] || b,
            c.hotkey = a.hotkey,
            $(d).trigger(c, a),
            c.result
        },
        ...
        a.prototype.open = function(a) {
            var b;
            return (b = $(a).find(".js-navigation-open").attr("href")) ? window.location = b: $(a).trigger("navigation:open"),
            !1
        },
        ...
        a.prototype.onFocus = function(a) {
            ...
            b = a.currentTarget,
            c = this.getItems()[0],
            d = $(a.target).closest(".js-navigation-item")[0] || c,
            this.activate(b),
            this.focusItem(d)
        },
        a.prototype.activate = function(a) {
            ...
            if (a !== b) return b && (b.id = null),
            a.id = "js-active-navigation-container"
        },
        ...
        a.prototype.pageUp = function(a) {
            ...
            c = this.getItems(),
            b = $.inArray(a, c);
            while ((d = c[b - 1]) && this.topViewOffset(d) >= 0) b--;
            if (d) return this.focusItem(d),
            this.scrollIntoView(d)
        },
        a.prototype.pageDown = function(a) {
            ...
            c = this.getItems(),
            b = $.inArray(a, c);
            while ((d = c[b + 1]) && this.bottomViewOffset(d) >= 0) b++;
            return d && (this.focusItem(d), this.scrollIntoView(d)),
            !1
        },
        a.prototype.focusItem = function(a) {
            return $("#js-active-navigation-container .js-navigation-item.navigation-focus").removeClass("navigation-focus"),
            $(a).addClass("navigation-focus"),
            !1
        },
        a.prototype.scrollIntoView = function(a) {
            var b,
            c;
            if (this.bottomViewOffset(a) <= 0) return c = $(a).offset().top,
            $("html, body").animate({
                scrollTop: c - 30
            },
            200);
            if (this.topViewOffset(a) <= 0) return b = $(a).offset().top + $(a).outerHeight() - $(window).height(),
            $("html, body").animate({
                scrollTop: b + 30
            },
            200)
        },
        a.prototype.topViewOffset = function(a) {
            return $(a).offset().top - $(window).scrollTop()
        },
        a.prototype.bottomViewOffset = function(a) {
            return $(window).height() - this.topViewOffset(a) - $(a).outerHeight()
        },
...
function() {
    ...
    a = function() {
        function a() {
            this.onToggle = b(this.onToggle, this),
            this.onError = b(this.onError, this),
            this.onSuccess = b(this.onSuccess, this),
            this.onComplete = b(this.onComplete, this),
            this.onBeforeSend = b(this.onBeforeSend, this),
            this.onClick = b(this.onClick, this),
        ...
        return a.prototype.onClick = function(a) {
            return $(a.target).trigger("toggler:toggle"),
            !1
        },
...
GitHub.Blob.show = function() {
    ...
    $.hotkeys({
        ...
        l: function() {
            return $(document).one("reveal.facebox",
            function() {
...
$(function() {
    $(".js-blob-edit-form").show(),
    $(".js-blob-edit-progress").hide(),
    window.editor = new GitHub.CodeEditor(".file-editor-textarea", {
    ...
    $(".js-blob-edit-actions .preview").click(function() {
        return $(this).is(".selected") ? !1: ($(".js-blob-edit-form").contextLoader(36), $(".js-blob-edit-actions a").toggleClass("selected"), $.ajax({
            ...
            success: function(a) {
                ...
                b.length || (b = $(a).filter("#readme")),
                b.length || (b = '<h3 class="no-preview">No changes</h3>'),
                $(".js-commit-preview").append(b)
            },
            error: function() {
                $(".js-commit-preview").append('<h3 class="no-preview">Error loading preview.</h3>')
            },
            complete: function() {
                $(".context-loader").remove(),
                $(".js-commit-create").hide()
            }
        }), !1)
    });
...
$(function() {
    $.hotkeys({
        y: function() {
            ...
            b = $("title");
            a && (a += location.hash, Modernizr.history ? window.history.pushState({},
            b, a) : window.location.href = a)
        }
    })
}),
GitHub.CodeEditor = function(a, b) {
    ...
    this.filename = this.textarea.attr("data-filename"),
    this.ace = this.createEditor(c),
    this.setTheme("twilight"),
    this.ace.setShowPrintMargin(!1),
    this.setMode(b.mode || d),
    this.setUseSoftTabs(b.useSoftTabs || this.usesSoftTabs(c)),
    this.setTabSize(b.tabSize || this.useSoftTabs ? this.guessTabSize(c) : 8),
    b.useWrapMode && this.setUseWrapMode(b.useWrapMode),
    ...
    this.useSoftTabs ? console.log("indent: %d", this.tabSize) : console.log("indent: \\t"),
...
GitHub.CodeEditor.prototype = {
    ...
    createEditor: function(a) {
        return this.div = this.swapTextareaWithEditorDiv(a),
        ace.edit(this.div[0])
    },
    ...
    swapTextareaWithEditorDiv: function(a) {
        ...
        $('<div id="ace-editor">').css("height", this.frame.height).css("width", this.frame.width).text(a).insertAfter(this.textarea)
    },
    setMode: function(a) {
    ...
    setupFormBindings: function() {
        var a = this;
        a.textarea.parents("form").bind("submit",
        function() {
    ...
    setupControlBindings: function() {
        ...
        }).val(b.useSoftTabs ? "spaces": "tabs"),
        $(a.indentWidthControl).change(function() {
            b.setTabSize(parseInt(this.value))
        }).val(b.tabSize),
        $(a.wrapModeControl).change(function() {
    ...
    setUseSoftTabs: function(a) {
        this.useSoftTabs = a,
        this.ace.getSession().setUseSoftTabs(a)
    },
    setTabSize: function(a) {
        this.tabSize = a,
        this.ace.getSession().setTabSize(a)
    },
...
Comment = {
    enhanceEmailToggles: function() {
        $(".email-hidden-toggle").each(function() {
            ...
            b.click(function() {
                return c.is(":visible") ? (c.hide(), b.html("Show quoted text")) : (c.show(), b.html("Hide quoted text")),
                !1
            })
        })
    }
...
$(function() {
    ...
    $(document).delegate(".js-add-a-comment", "click",
    function() {
        var a = $(this).attr("href");
        $(a).find("*[tabindex=1]").focus()
    }),
    $(document).delegate(".js-new-comment-form .action-bar a", "ajaxSend",
    function() {
        $(this).addClass("disabled")
    }),
    $(document).delegate(".js-new-comment-form", "ajaxBeforeSend",
    function(a) {
        if ($(a.target).is("form") && $.trim($(this).find('textarea[name="comment[body]"]').val()) == "") return ! 1
    }),
    $(document).delegate(".js-new-comment-form", "ajaxSend",
    function(a) {
        $(a.target).is("form") && $(this).find(".form-actions button").attr("disabled", "true")
    }),
    $(document).delegate(".js-new-comment-form", "ajaxComplete",
    function(a) {
        $(this).find(".form-actions button").attr("disabled", !1)
    }),
    $(document).delegate(".js-new-comment-form", "ajaxSuccess",
    function(a, b, c, d) {
        ...
        $("#discussion_bucket, #show_issue").trigger("pageUpdate"),
        $(a.target).is("form") && ($(this).find("textarea").val("").blur(), $(this).find("a[action=write]").click())
    }),
    $(document).delegate(".js-new-comment-form", "ajaxError",
    function() {
        ...
        function(c, d) {
            ...
            $.extend({
                getUrlVars: function() {
                    ...
                    for (var d = 0; d < c.length; d++) b = c[d].split("="),
                    b[1] && (b[1] = b[1].split("-")),
                    a.push(b[0]),
                    a[b[0]] = b[1];
                    return a
...
$(document).on("navigation:open", ".page-commits .commit-group-item",
function() {
    return window.location = $(this).find("a").attr("href"),
    !1
}),
$(document).on("navigation:keydown", ".page-commits .commit-group-item",
function(a) {
    if (a.hotkey === "c") return window.location = $(this).find("a").attr("href"),
    !1
}),
$(function() {
...
$(function() {
    ...
    if ($(".js-edit-details").length) {
        ...
        j = i.find(".error");
        $(".repo-desc-homepage").delegate(".js-edit-details", "click",
        function(a) {
            a.preventDefault(),
            h.hide(),
            i.show(),
    ...
    $(document.body).hasClass("logged_in") || ($(".watch-button").enticeToAction(), $(".fork-button").enticeToAction())
}),
$(function() {
...
GitHub.Uploader = {
    ...
    showUploadStarted: function(a) {
        a.row.find(".js-label").text("Uploading鈥�0%")
    },
    showProgress: function(a, b) {
        a.row.find(".description label").text("Upload in progress鈥� " + b + "%")
    },
    ...
    saveFile: function(a) {
        ...
        a.row.find("button").attr("disabled", "disabled").find("span").text("Uploading鈥�"),
    ...
    fileSaveSucceeded: function(a, b) {
        ...
        a.params.policy = b.policy,
        a.params.AWSAccessKeyId = b.accesskeyid,
        a.params.signature = b.signature,
        a.params["Content-Type"] = b.mime_type,
        a.uploader == "flash" && (a.params.success_action_status = "201", GitHub.Uploader.Flash.upload(a)),
        this.fallbackEnabled && (a.params.redirect = b.redirect, this.fallbackFileSaved = !0, $("#s3_redirect").val(a.params.redirect), $("#s3_key").val(a.params.key), $("#s3_acl").val(a.params.acl), $("#s3_filename").val(a.params.Filename), $("#s3_policy").val(a.params.policy), $("#s3_accesskeyid").val(a.params.AWSAccessKeyId), $("#s3_signature").val(a.params.signature), $("#s3_mime_type").val(a.params["Content-Type"]), this.uploadForm.submit())
    },
    fileSaveFailed: function(a, b) {
        b == null && (b = "Something went wrong that shouldn't have. Please try again or contact support if the problem persists."),
        a.row.addClass("error"),
        a.row.find(".js-label").text(b),
        a.row.find("button").attr("disabled", "").addClass("danger").find("span").text("Remove"),
        a.row.find("button").click(function(b) {
            return a.row.remove(),
            !1
        })
    }
...
GitHub.UploadFile = function(a) {
    this.id = a.id,
    this.name = a.name,
    this.escapedName = $("<div>").text(a.name).html(),
    this.row = a.row,
    this.size = a.size,
    this.type = a.type,
...
$(function() {
    ...
    function() {
        return $("#manual_downloads").toggleClass("managing"),
        !1
    })
}),
$(function() {
    ...
    if ($("#edit_repo").length > 0) {
        ...
        $("#push_pull_collabs input.ac-add-user-input").userAutocomplete().result(d),
        $("#push_pull_collabs form").submit(function() {
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function(b) {
                    a.val("").removeClass("ac-accept"),
                    b.error ? c(b.error) : $("#push_pull_collabs ul.usernames").append(b.html)
                },
                error: function() {
        ...
        $("#teams form").submit(function() {
            ...
            return b == "" ? (c("You must select a team"), !1) : (c(), $.ajax({
                ...
                success: function(b) {
                    a.val(""),
                    b.error ? c(b.error) : $("#teams ul.teams").append(b.html)
                },
                error: function() {
                    c("An unidentfied error occurred, try again?")
                }
        ...
        $("#custom_tabs .remove-tab").live("click",
        function() {
            return $.del(this.href),
            $(this).closest("li").remove(),
            !1
        ...
        e.find("input[type=radio]").change(function(a) {
            if ($(this).attr("value") == "public") return a.preventDefault(),
            ...
            if ($(this).attr("value") == "private") {
                if (!confirm("Are you POSITIVE you want to make this public repository private?  All public watchers will be removed.")) return $("input[value=public]").attr("checked", "checked"),
                !1;
                f($(this))
            }
        });
        var f = function(a) {
            ...
            b.removeClass("success").removeClass("error").addClass("loading"),
            $.ajax({
                type: "POST",
                url: b.closest("form").attr("action"),
                success: function() {
                    $(".repohead").is(".vis-public") ? ($(".repohead").removeClass("vis-public").addClass("vis-private"), $(".private-only").show(), $(".public-only").hide()) : ($(".repohead").removeClass("vis-private").addClass("vis-public"), $(".private-only").hide(), $(".public-only").show()),
                    b.removeClass("loading").addClass("success")
                },
                error: function() {
                    a.checked = !1,
                    b.removeClass("loading").addClass("error")
                }
            })
        };
        ...
        function() {
            ...
            $("#facebox .transfer_to_field").val($("#transfer_field").val())
        })
    }
}),
$(function() {
...
$(function() {
    ...
    function(a) {
        $(".trending-repositories .ranked-repositories").fadeTo(200, .5),
        ...
        error: function(a, b) {
            ...
            $(".trending-repositories ol").empty().append("<li>Something went wrong: " + b + "</li>")
        }
    })
}),
$(function() {
    ...
    if (c.length > 0) {
        ...
        var f = function(a) {
            ...
            return d += parseInt(b.css("margin-left")),
            d
        };
        c.bind("tabChanged",
        function(a, b) {
...
$(function() {
    function b() {
        ...
        if (a > 0) {
            ...
            e = d.attr("name");
            $(".icons", d).html('<img src="/images/modules/ajax/indicator.gif" alt="Processing" />'),
            $.get("forkqueue/applies/" + c + "/" + e,
            function(a) {
                d.removeClass("untested"),
                a == "NOPE" ? (d.addClass("unclean"), $(".icons", d).html("")) : a == "YUP" ? (d.addClass("clean"), $(".icons", d).html("")) : $(".icons", d).html("err"),
                b()
            })
        }
    }
    function d() {
        ...
        if (a > 0) {
            ...
            f = e.attr("name");
            $(".date", e).html("applying"),
            $(".icons", e).html('<img src="/images/modules/ajax/indicator.gif" alt="Processing" />'),
            $.post("patch/" + b + "/" + f,
            function(a) {
                e.removeClass("not-applied"),
                a == "NOPE" ? (e.addClass("unclean_failure"), $(".date", e).html("failed"), $(".icons", e).html('<img src="/images/icons/exclamation.png" alt="Failed" />')) : ($("#head-sha").text(a), e.addClass("clean"), $(".date", e).html("applied"), $(".apply-status", e).attr("value", "1"), $(".icons", e).html('<img src="/images/modules/dashboard/news/commit.png" alt="Applied" />')),
                d()
            })
        } else $("#new-head-sha").attr("value", b),
        $("#finalize").show()
    }
    ...
    $(".action-choice").change(function(a) {
        ...
        if (b == "ignore") {
            ...
            e.each(function(a, b) {
                var c = $(b).attr("ref");
                $(b).parents("tr").children(".icons").html("ignoring..."),
                $.post("forkqueue/ignore/" + c, {})
            });
    ...
    $("#forkqueue a.select_all").click(function() {
        ...
        return $(this).addClass("select_all"),
        $("#forkqueue tr." + a + " input[type=checkbox]").attr("checked", "true"),
        c = [],
        !1
    }),
    $("#forkqueue a.select_none").click(function() {
        ...
        var a = $(this).attr("class");
        return $(this).addClass("select_none"),
        $("#forkqueue tr." + a + " input[type=checkbox]").removeAttr("checked"),
        c = [],
        !1
    }),
    ...
    $("#change-branch").click(function() {
        return $("#int-info").hide(),
        $("#int-change").show(),
        !1
    }),
    $("#change-branch-nevermind").click(function() {
        return $("#int-change").hide(),
        $("#int-info").show(),
        !1
    }),
    $(".js-fq-new-version").each(function() {
        ...
        $.smartPoller(function(c) {
            $.getJSON("/cache/network_current/" + a,
            function(a) {
...
$(function() {
    var a = {
        success: function() {
            ...
            function(a) {
                ...
                function(b) {
                    if (b == 0) return a();
                    b.length == 0 ? ($("#new_import input[type=submit]").attr("disabled", "").val("Import SVN Authors").show(), alert("No authors were returned, please try a different URL")) : ($.each(b,
                    function(a, b) {
        ...
        beforeSubmit: function(a, b) {
            var c = $("#svn_url").val();
            if (!c.match(/^https?:\/\//) && !c.match(/^svn:\/\//)) return alert("Please enter a valid subversion url"),
            !1;
    ...
    $("#import-submit").click(function() {
        ...
        b > 0 && c > 0 && (alert("You must either fill in all author names or none."), a = !0),
        $("#authors-list input.git_author").each(function() {
            var b = $(this).val(); ! a && b != "" && !/^[^<]+<[^>]+>$/.test(b) && (alert("'" + b + "' is not a valid git author.  Authors must match the format 'User Name <user@domain>'"), a = !0)
        });
        if (a) return $("#import-submit").attr("disabled", ""),
        !1;
...
$(function() {
    ...
    $("#inbox .del a").click(function() {
        ...
        d = ".js-" + c + "-count";
        return a.find("img").attr("src", GitHub.Ajax.spinner),
        $.ajax({
            type: "DELETE",
            url: a.attr("rel"),
            error: function() {
...
GitHub.ImpactGraph = {
    ...
    initColors: function(a) {
        ...
        for (var c in a) {
            ...
            b > 6 && (d = [this.randColorValue(d[0]), this.randColorValue(d[1]), this.randColorValue(d[2])]),
            this.colors.push(d),
            b += 1
        }
    },
    ...
    createCanvas: function(a) {
        ...
        var i = $("#impact_graph");
        i.height(c + 50).css("border", "1px solid #aaa"),
        $("#caption").show(),
        i.append('<canvas width="' + b + '" height="' + (c + 30) + '"></canvas>');
    ...
    drawBucket: function(a, b, c) {
        ...
        function(b, f) {
            ...
            a[g] || (a[g] = new Array),
            a[g].push([c * 100, d, 50, h, f[1]]),
            d = d + h + e.chunkVerticalSpace
        })
    },
    ...
    drawAll: function(a, b, c) {
        this.drawStreams(a, c, null),
        this.drawDates(b)
    },
    drawStreams: function(a, b, c) {
        a.clearRect(0, 0, 1e4, 500),
        $(".activator").remove();
    ...
    drawStream: function(a, b, c, d) {
        ...
        for (var e = 0; e < chunks.length; e++) {
            var f = chunks[e];
            c.fillRect(f[0], f[1], f[2], f[3]),
            d && this.placeActivator(a, b, c, f[0], f[1], f[2], f[3], f[4]),
            e != 0 && (c.beginPath(), c.moveTo(previousChunk[0] + 50, previousChunk[1]), c.bezierCurveTo(previousChunk[0] + 75, previousChunk[1], f[0] - 25, f[1], f[0], f[1]), c.lineTo(f[0], f[1] + f[3]), c.bezierCurveTo(f[0] - 25, f[1] + f[3], previousChunk[0] + 75, previousChunk[1] + previousChunk[3], previousChunk[0] + 50, previousChunk[1] + previousChunk[3]), c.fill()),
            previousChunk = f
        }
    },
    ...
    drawStat: function(a, b, c) {
        ...
        d += "font-size: 9px;",
        d += "z-index: 0;",
        $("#impact_graph").append('<p class="stat" style="' + d + '">' + a + "</p>")
    },
    drawDate: function(a, b, c) {
        ...
        d += "color: #888;",
        d += "font-size: 9px;",
        $("#impact_graph").append('<p style="' + d + '">' + a + "</p>")
    },
    placeActivator: function(a, b, c, d, e, f, g, h) {
        ...
        $("#" + j).mouseover(function(b) {
            $(b.target).css("background-color", "black").css("opacity", "0.08"),
            k.drawAuthor(a)
        }).mouseout(function(a) {
    ...
    authorText: function(a, b, c) {
        ...
        e += "color: #444;",
        e += "font-size: 18px;",
        $("#impact_legend").append('<p id="' + d + '" style="' + e + '">' + a + "</p>")
    },
    authorHint: function() {
    ...
    drawAuthor: function(a) {
        ...
        b.fillRect(0, 30, 20, 20),
        b.strokeRect(.5, 30.5, 19, 19);
...
GitHub.BaseBrowser = {
    ...
    init: function(a) {
        ...
        c.each(function() {
            ...
            case "open":
                b.showingOpen && a.addClass("selected"),
                a.click(function() {
                    a.toggleClass("selected"),
                    b.showOpen(a.hasClass("selected"))
                });
                break;
            case "closed":
                b.showingClosed && a.addClass("selected"),
                a.click(function() {
                    a.toggleClass("selected"),
                    b.showClosed(a.hasClass("selected"))
                });
                break;
            case "read":
                b.showingRead && a.addClass("selected"),
                a.click(function() {
                    a.toggleClass("selected"),
                    b.showRead(a.hasClass("selected"))
                })
            }
        }),
        ...
        this.sortElements.each(function() {
            var a = $(this);
            a.attr("data-sort") == b.activeSort[0] && (d = a.addClass(b.activeSort[1])),
            a.click(function() {
                var a = $(this);
                d && d.attr("data-sort") != a.attr("data-sort") && d.removeClass("asc").removeClass("desc"),
                a.hasClass("desc") ? (b.sortBy(a.attr("data-sort"), "asc"), a.removeClass("desc").addClass("asc")) : (b.sortBy(a.attr("data-sort"), "desc"), a.removeClass("asc").addClass("desc")),
                d = a
            })
        }),
    ...
    initNavigation: function() {
        ...
        this.wrapper.find("ul.bignav a, ul.smallnav a").click(function(b) {
            var c = $(this);
        ...
        e = function() {
            d.show(),
            b.val() != "" && d.filter(":not(:Contains('" + b.val() + "'))").hide()
        },
        f = b.val();
        b.bind("keyup blur click",
        function() {
    ...
    getPulls: function(a, b) {
        var c = this;
        b == undefined && (b = {}),
        a != this.lastUrl && (this.currentPage = 1),
        this.startLoading(),
        $.ajax({
            url: a,
            data: b,
            success: function(d) {
                ...
                c.cancelLoading(),
                c.errorElement.hide(),
                c.lastPage == b["page"] || b["page"] == 1 || b["page"] == undefined ? c.render(d) : c.render(d, !0),
                c.lastUrl = a,
                b.page && (c.lastPage = b.page)
            },
            error: function() {
                c.errored = !0,
                c.showError()
    ...
    startLoading: function() {
        this.listingsElement.fadeTo(200, .5),
        this.noneShownElement.is(":visible") && this.noneShownElement.fadeTo(200, .5),
    ...
    render: function(a, b) {
        b == undefined && (b = !1),
        b ? this.listingsElement.append(a) : this.listingsElement.html(a),
        this.listings = this.listingsElement.find(".listing"),
        this.listingsElement.trigger("pageUpdate"),
        this.currentPage == 1 && this.listings.length >= this.pagingLimit && (this.pagingElement.show(), $(this.listings[this.listings.length - 1]).remove(), this.listings = this.listingsElement.find(".listing"));
        if (b) {
    ...
    setCounts: function(a, b) {
        ...
        this.titleElement.text(c),
        this.footerElement.text(d)
    },
    showOpen: function(a) {
        this.currentPage = 1,
        a ? this.showingOpen = !0: this.showingOpen = !1,
        this.remoteUpdate()
    },
    showRead: function(a) {
        a ? this.showingRead = !0: this.showingRead = !1,
        this.update()
    },
    showClosed: function(a) {
        this.currentPage = 1,
        a ? this.showingClosed = !0: this.showingClosed = !1,
        this.remoteUpdate()
    },
    showMore: function() {
    ...
    remoteUpdate: function(a) {
        ...
        if (!this.showingClosed || !this.showingOpen) this.showingOpen || b.exclude.push("open"),
        this.showingClosed || b.exclude.push("closed"),
        b.exclude = b.exclude.join(",");
        this.getPulls(a, b)
    }
},
GitHub.PullRequestBrowser = {},
jQuery.extend(!0, GitHub.PullRequestBrowser, GitHub.BaseBrowser),
$(function() {
...
$(function() {
    ...
    if (d.length > 0) {
        ...
        e && !location.search && Modernizr.history && window.history.replaceState(null, document.title, location.pathname + "?" + e),
        d.pageUpdate(function() {
            var a = d.find(".js-filterable-milestones").milestoneSelector();
            a.unbind(".milestoneSelector"),
            a.bind("beforeAssignment.milestoneSelector",
            function() {
                var a = [];
            ...
            a.bind("afterAssignment.milestoneSelector",
            function() {
                b(d.selector, f({
                    preservePage: !0
                }))
        ...
        d.bind("start.pjax",
        function(a) {
            d.find(".context-loader").show(),
            d.find(".issues").fadeTo(200, .5)
        }).bind("end.pjax",
        function(a) {
            d.find(".issues").fadeTo(200, 1),
            d.find(".context-loader").hide()
        });
        var f = function(a) {
            a || (a = {});
            var b = {
            ...
            e != "" && e != null && (b.milestone = e),
            d.find(".sidebar ul.labels").find(".selected").each(function(a, c) {
                b.labels.push($(c).attr("data-label"))
            }),
            b.labels = b.labels.join(","),
            b.labels == "" && delete b.labels;
            var f = d.find(".main .filterbar ul.sorts").find(".asc, .desc");
            b.sort = f.attr("data-sort"),
            b.direction = f.attr("class"),
            b.state = d.find(".main .filterbar ul.filters").find(".selected").attr("data-filter");
        ...
        d.delegate(".pagination a, #clear-active-filters", "click",
        function(a) {
            a.preventDefault(),
            b(d.selector, $(this).attr("href"))
        }),
        d.selectableList(".sidebar ul.bignav", {
            mutuallyExclusive: !0
        }),
        d.selectableList(".sidebar ul.labels"),
        d.selectableList(".main .filterbar ul.filters", {
            wrapperSelector: "",
            mutuallyExclusive: !0
        }),
        ...
        d.sortableHeader(".main .filterbar ul.sorts"),
        d.contextButton(".sidebar .milestone .js-milestone-context", {
            contextPaneSelector: ".milestone-context"
        }),
        d.delegate(".milestone-context .pane-selector .milestone", "click",
        function(a) {
            var b = $(this);
            b.closest(".milestone-context").attr("data-selected-milestone", b.attr("data-milestone")),
            b.closest(".milestone-context").trigger("close")
        }),
        d.delegate(".issues table", "click",
        function(a) {
            var b = $(a.target);
            ...
            e.length > 0 ? (f.addClass("activated"), f.removeClass("deactivated")) : (f.removeClass("activated"), f.addClass("deactivated"))
        }),
        d.find(":checked").removeAttr("checked"),
        $(document).on("navigation:keydown", ".issues .issue",
        function(a) {
            a.hotkey == "x" && $(this).click()
        });
        var h = function(a) {
            var c = {
                issues: []
        ...
        var k = "#issues_list .label-context";
        d.delegate(".label-context button.update-labels", "click",
        function(a) {
            var c = $(this),
            e = {
                labels: [],
        ...
        d.selectableList(".label-context ul.labels"),
        d.delegate(".issues .btn-close, .issues .btn-reopen", "click",
        function(a) {
            h($(this).attr("data-url"))
        }),
        d.delegate(".issues .btn-label", "click",
        function(b) {
            var c = d.find(".issues :checked").closest(".issue").find(".label");
            a.find(k + " .label a.selected").removeClass("selected"),
            a.find(k + " :checked").attr("checked", !1),
            c.each(function(b, c) {
                var d = $(c).attr("data-name");
                a.find(k + " .label[data-name='" + d + "'] a").addClass("selected"),
                a.find(k + " .label[data-name='" + d + "'] :checkbox").attr("checked", !0)
            })
        }),
        d.contextButton(".issues .btn-label", {
            contextPaneSelector: k
        }),
        ...
        d.delegate(".issues .btn-assignee", "click",
        function(a) {
            var b = $(".assignee-assignment-context");
            b.data("applied") != 1 && (b.data("applied", !0), b.assigneeFilter(l))
        }),
        d.delegate(".assignee-assignment-context :radio", "change", l),
        d.selectableList("ul.color-chooser", {
            wrapperSelector: "li.color",
            mutuallyExclusive: !0
        }),
        d.delegate("ul.color-chooser li.color", "click",
        function(a) {
            var b = $(this).find("input[type=radio]").val(),
            c = $("#custom_label_text");
            c.text(c.attr("data-orig"))
        }),
        d.delegate(g.join(","), "click",
        function(a) {
            Modernizr.history || (a.preventDefault(), window.location = f())
        })
    }
    var m = a.find("#milestone_list");
    if (m.length > 0) {
        m.bind("start.pjax",
        function(a) {
            m.find(".context-loader").show(),
            m.find(".milestones").fadeTo(200, .5)
        }).bind("end.pjax",
        function(a) {
            m.find(".milestones").fadeTo(200, 1),
            m.find(".context-loader").hide()
        });
        var g = [".sidebar ul.bignav a", ".main .filterbar ul.filters li", ".main .filterbar ul.sorts li"];
        m.delegate(g.join(","), "click",
        function(a) {
        ...
        m.selectableList(".sidebar ul.bignav", {
            mutuallyExclusive: !0
        }),
        m.selectableList(".main .filterbar ul.filters", {
            wrapperSelector: "",
            mutuallyExclusive: !0
        }),
        m.sortableHeader(".main .filterbar ul.sorts")
    }
}),
function(a) {
    a.fn.milestoneSelector = function(b) {
        var c = a.extend({},
        a.fn.milestoneSelector.defaults, b);
        return this.each(function() {
            var b = a(this),
            ...
            l.keyup(function(b) {
                ...
                switch (b.which) {
                case 38:
                    return r(c.prevAll(".selector-item:visible:first")),
                    !1;
                case 40:
                    return c.length ? r(c.nextAll(".selector-item:visible:first")) : r(a(e.filter(":visible:first"))),
                    !1;
                case 13:
                    return s(c),
                    !1
            ...
            d.bind("deactivated.contextPane",
            function() {
                z(),
                l.val(""),
                l.trigger("keyup")
            ...
            s = function(e) {
                ...
                c.newMode ? (n.val(g[0].value), f.removeClass("selected"), e.addClass("selected"), d.trigger("close"), b.trigger("afterAssignment.milestoneSelector")) : u({
                    url: g[0].form.action,
                    params: {
                        milestone: g[0].value,
            ...
            t = function(a) {
                b.trigger("beforeAssignment.milestoneSelector"),
                c.newMode ? (n.val("new"), o.val(l.val()), f.removeClass("selected"), a.addClass("selected"), d.trigger("close"), b.trigger("afterAssignment.milestoneSelector")) : u({
            ...
            u = function(c) {
                ...
                a.ajax({
                    ...
                    success: function(a) {
                        x(),
                        m.html(a.infobar_body).trigger("pageUpdate"),
                        d.trigger("close"),
                        b.html(a.context_pane_body).milestoneSelector().trigger("pageUpdate"),
                        b.trigger("afterAssignment.milestoneSelector")
                    },
                    error: function() {
                        x(),
                        y()
            ...
            v = function() {
                var b = null;
                p == "open" ? (i.show(), h.hide(), b = g) : (i.hide(), g.hide(), b = h),
                q != "" && q != null ? (b.each(function() {
                    var b = a(this),
            ...
            v();
            var w = function() {
                d.find(".body").append('<div class="loader">Loading鈥�</div>')
            },
            x = function() {
...
$(function() {
    ...
    d.bind("afterAssignment.milestoneSelector",
    function() {
...
$(function() {
    ...
    a.find(".js-filterable-milestones").milestoneSelector(),
    ...
    g.find("input[type=checkbox]").change(function() {
        $.post(g.attr("action"), g.serialize(),
        function(a) {
    ...
    h.delegate("input[type=radio]", "change",
    function() {
        var a = $(this);
...
$(function() {
    ...
    e = this;
    b = $("#issues-dashboard");
    if (b.length > 0) return d = b.attr("data-url"),
    d && !location.search && Modernizr.history && window.history.replaceState(null, document.title, d),
    a = $("#issues-dashboard .list"),
    c = ["" + a.selector + " .nav.big a", "" + a.selector + " .nav.small a", "#clear-active-filters", "" + a.selector + " .filterbar .filters a", "" + a.selector + " .filterbar .sorts a"].join(", "),
    $(c).pjax(a.selector, {
        timeout: null
    }),
    a.bind("start.pjax",
    function() {
        return $(e).find(".context-loader").show(),
        $(e).find(".listings").fadeTo(200, .5)
    }).bind("end.pjax",
    function() {
        return $(e).find(".listings").fadeTo(200, 1),
        $(e).find(".context-loader").hide()
    })
}),
function() {
    var a = location.pathname + location.hash,
    b = a.match(/#issue\/(\d+)(\/comment\/(\d+))?/);
    if (b) {
        var c = b[1],
        d = b[3];
...
$(function() {
    ...
    window.jobsWidgetCallback = function(b) {
        ...
        d = b.jobs[c];
        a.find(".job-link").attr("href", d.url),
        a.find(".job-company").text(d.company),
        a.find(".job-position").text(d.position),
        a.find(".job-location").text(d.location),
        a.css({
            visibility: "visible"
        })
    },
...
$(function() {
    ...
    $("body").delegate("form.key_editing", "submit",
    function(a) {
        var b = this;
        return $(b).find(".error_box").remove(),
        $(b).find(":submit").attr("disabled", !0).spin(),
        $(b).ajaxSubmit(function(a) {
            a.substring(0, 3) == "<li" ? ($(b).attr("id").substring(0, 4) == "edit" ? ($("#" + $(b).attr("id").substring(5)).replaceWith(a), $.facebox.close()) : ($("ul.public_keys").append(a), $("#add_key_action").toggle(), $("#new_key_form_wrap").toggle()), $(b).find("textarea").val(""), $(b).find(":text").val("")) : $(b).append(a),
            $(b).find(":submit").attr("disabled", !1).stopSpin()
        }),
        !1
    })
}),
GitHub = GitHub || {},
GitHub.metric = function(a, b) {
...
GitHub.trackClick = function(a, b, c) {
    ...
    $(a).click(function() {
        return c = $.isFunction(c) ? c.call(this) : c,
        GitHub.metric(b, c),
        !0
    })
},
...
$(document).pageUpdate(function() {
    return $(this).find(".js-obfuscate-email").each(function() {
        ...
        c,
        d;
        if (d = $(this).attr("data-email")) return a = decodeURIComponent(d),
        c = $(this).text().replace(/{email}/, a),
        b = $(this).attr("href").replace(/{email}/, a),
        $(this).text(c),
        $(this).attr("href", b)
    })
}),
$(function() {
    ...
    $("#members_bucket .remove-user").click(function() {
        ...
        return confirm(d) ? (b.spin().remove(), a = $("#spinner").addClass("remove"), $.del(b.attr("href"),
        function() {
            a.parent().remove()
        }), !1) : !1
    })
...
$(function() {
    ...
    a.click(function() {
        return $(this).toggle(),
        c.fadeIn(200).find(":text").focus(),
        !1
    }),
    b.click(function() {
        return a.toggle(),
        c.hide().find(":text").val(""),
        d.hide(),
        !1
    }),
    ...
    $("ul.user_emails li.email").length > 0 && $("#add_email_form").submit(function() {
        ...
        return $(this).ajaxSubmit(function(b) {
            b ? $("ul.user_emails").append(b) : d.show(),
            $("#add_email_form :submit").attr("disabled", !1).stopSpin(),
            $(a).find(":text").val("").focus()
        }),
        !1
    }),
    $(".user_toggle").click(function() {
        var a = {};
        a[this.name] = this.checked ? "1": "0",
        a._method = "put",
        $.post("/account", a),
        $("#notify_save").show(),
        setTimeout("$('#notify_save').fadeOut()", 1e3)
    }),
    $("dl.form.autosave").autosaveField(),
    $("button.dummy").click(function() {
        return $(this).prev(".success").show().fadeOut(5e3),
        !1
    }),
    ...
    function(a) {
        ...
        return d.addClass("no-bg"),
        d.html('<img src="/images/modules/ajax/indicator.gif">'),
        $.ajax({
    ...
    $("body").delegate(".change-gravatar-email form", "submit",
    function() {
        var a = $(this),
        ...
        return $.ajax({
            ...
            success: function(b) {
                c.html('<img src="/images/modules/ajax/success.png"/>'),
                a.find(".error").text("");
                var d = $(".change-gravatar-email .gravatar img").attr("src");
                $(".change-gravatar-email .gravatar img").attr("src", d.replace(/[a-f0-9]{32}/, b)),
            ...
            error: function(b) {
                c.html('<img src="/images/modules/ajax/error.png"/>'),
                a.find(".error").text(b.responseText)
            },
            complete: function() {
                b.attr("disabled", !1)
            }
...
$(function() {
    ...
    $(".js-edit-org-select-billing").click(function() {
        return $("a[href=#billing_bucket]").click(),
        !1
    });
    ...
    a.find(".choose_plan").click(function() {
        ...
        $(".js-new-plan-name-val").val(a),
        $(".js-new-plan-name").text(a),
        a == "free" ? $(".js-new-plan-card-on-file").hide() : $(".js-new-plan-card-on-file").show()
    }),
    $("body").delegate(".js-coupon-form", "submit",
    function() {
        return $(this).find("button").attr("disabled", !0).after(' <img src="/images/modules/ajax/indicator.gif">'),
        $.ajax({
            url: this.action,
            type: this.method,
            data: {
    ...
    $(".js-show-credit-card-form")[0] && ($.facebox({
...
$(function() {
    ...
    var e = function() {
        ...
        e.val(d == "start" ? b: c),
        $("#facebox .mode-upper").text(a(d)),
        $("#facebox .mode-lower").text(d),
        d == "start" ? f.show() : f.hide()
    },
    f = function() {
        ...
        e(),
        g.click(function() {
            return d == "start" ? b = a.val() : c = a.val(),
            $(document).trigger("close.facebox"),
            document.location = h + b + "..." + c,
            !1
        }),
        a.click(function() {
            return this.focus(),
        ...
        function() {
            i && j.abort(),
            i = !0,
            j = $.get(f.attr("url_base") + a.val(), null,
            function(a) {
                a.length > 0 && (f.html(a), f.find("a").attr("target", "_blank"), f.trigger("pageUpdate")),
                i = !1
            })
        };
        k();
    ...
    $(document).bind("reveal.facebox", f),
    b == c && $(".compare-range .commit-ref.from").click();
    var g = window.location.hash.substr(1); (/^diff-/.test(g) || /^L\d+/.test(g)) && $("li a[href='#files_bucket']").click()
}),
$(function() {
    var a;
    if ($(".js-leaving-form")[0]) return a = function() {
        var a;
        return a = new WufooForm,
        a.initialize({
            userName: "github",
            formHash: "q7x4a9",
            autoResize: !0,
    ...
    function() {
        var b,
        c;
        return b = document.location.protocol === "https:" ? "https://secure.": "http://",
        c = document.createElement("script"),
        c.type = "text/javascript",
        c.src = "" + b + "wufoo.com/scripts/embed/form.js",
        c.onload = a,
...
$(function() {
    ...
    $("button#update_commit_range").click(function() {
        b.attr("data-update", "yes"),
        b.attr("action", $(this).data("url")),
        b.submit()
    }),
    ...
    $(".js-refchooser").each(function() {
        $(this).refChooser({
            change: function() {
                $(this).attr("data-ref-valid", !1),
                $("button#update_commit_range").attr("disabled", !0)
            },
            found: function() {
                $(this).attr("data-ref-valid", !0),
    ...
    a.fn.refChooser = function(b) {
        ...
        return this.each(function() {
            ...
            l = function() {
                ...
                k = a.get(l, null,
                function(a) {
                    a.length > 0 && (g.html(a), g.trigger("pageUpdate"), g.find(".error").length == 0 ? c.found.call(b) : c.missing.call(b)),
                    j = !1
                })
            },
            m = f.val(),
...
$(function() {
    ...
    e = function() {
        a.show(),
        b.val() != "" && a.filter(":not(:Contains('" + b.val() + "'))").hide()
    };
    b.bind("keyup blur click",
    function() {
...
$(function() {
    ...
    $("#pull_closed_warning a").click(function() {
        return $("#pull_closed_warning").hide(),
    ...
    if (a.length > 0) {
        ...
        a.click(function() {
            return b.is(":visible") ? (b.hide(), c.show()) : (b.show(), c.hide()),
            !1
        })
    }
...
function() {
    ...
    if (typeof $ == "undefined" || $ === null) return;
    GitHub.Theme = function() {
        function a(a) {
            var b;
            b = $(a),
            this.name = b.data("theme-name"),
            this.slug = b.data("theme-slug"),
            this.baseHref = b.attr("href")
        }
        return a.prototype.wrappedKey = function(a, b) {
        ...
        a.prototype.params = function(a) {
            ...
            b = {},
            b[this.wrappedKey("theme_slug", a)] = this.slug,
            this.color && (b[this.wrappedKey("theme_color_class", a)] = this.color),
            this.font && (b[this.wrappedKey("theme_font_class", a)] = this.font),
            b
        },
        a.prototype.previewSrc = function() {
            return [this.baseHref, $.param(this.params())].join("&")
        },
        a
    } (),
    GitHub.ThemePicker = function() {
        function b() {
            this.onPublishClick = a(this.onPublishClick, this),
            this.onHideClick = a(this.onHideClick, this),
            this.onFontChange = a(this.onFontChange, this),
            this.onColorLinkClick = a(this.onColorLinkClick, this),
            this.onThemeLinkClick = a(this.onThemeLinkClick, this),
            this.onThemeNavNextClick = a(this.onThemeNavNextClick, this),
            this.onThemeNavPrevClick = a(this.onThemeNavPrevClick, this),
            this.onSectionNavBasicClick = a(this.onSectionNavBasicClick, this),
            this.onSectionNavThemesClick = a(this.onSectionNavThemesClick, this);
            var b,
            c = this;
            this.fullPicker = $("#theme-picker-full"),
            this.miniPicker = $("#theme-picker-mini"),
            this.sectionNav = $("#theme-picker-section-nav"),
            this.themesSections = $(".theme-picker-section-themes"),
            this.basicSections = $(".theme-picker-section-basic"),
            ...
            this.colorLinks = $("ul.colors a"),
            this.fontSelects = $("select.fonts"),
            this.basicTheme = new GitHub.Theme($("a.theme-basic")),
            this.basicSelected = !1,
            this.themes = [],
            this.themeLinks.each(function(a, b) {
                return c.themes.push(new GitHub.Theme(b))
            }),
            this.selectedTheme = this.themes[0],
            b = this.sectionNav.find(".themes a"),
            b.click(this.onSectionNavThemesClick),
            this.sectionNav.find(".basic a").click(this.onSectionNavBasicClick),
            ...
            this.colorLinks.click(this.onColorLinkClick),
            this.fontSelects.change(this.onFontChange),
            $("#page-hide").click(this.onHideClick),
            $("#page-publish").click(this.onPublishClick),
            $(this.colorLinks[0]).click(),
            $(this.fontSelects[0]).change(),
            b.click(),
            this.miniPicker.hide()
        }
        return b.prototype.onSectionNavThemesClick = function(a) {
            return this.themesSections.show(),
            this.basicSections.hide(),
            this.basicSelected = !1,
            this.linkForTheme(this.selectedTheme).click(),
            !1
        },
        b.prototype.onSectionNavBasicClick = function(a) {
            return this.themesSections.hide(),
            this.basicSections.show(),
            this.basicSelected = !0,
            this.showPreviewFor(this.basicTheme),
            !1
        },
        b.prototype.onThemeNavPrevClick = function(a) {
            return this.theme(this.prevTheme())
        },
        b.prototype.onThemeNavNextClick = function(a) {
            return this.theme(this.nextTheme())
        },
        b.prototype.onThemeLinkClick = function(a) {
            return this.theme(this.themeForLink(a.currentTarget)),
            !1
        },
        b.prototype.onColorLinkClick = function(a) {
            return this.color($(a.currentTarget).data("theme-color")),
            !1
        },
        b.prototype.onFontChange = function(a) {
            var b;
            return b = $(a.target).find("option:selected").val(),
            this.fontSelects.each(function(a, c) {
                return $(c).val(b)
            }),
            this.font(b),
            !1
        },
        b.prototype.onHideClick = function(a) {
            return $("#header").toggle(),
            this.fullPicker.toggle(),
            this.miniPicker.toggle(),
            this.scrollToTheme(this.theme(), !1),
            $(a.target).text(this.fullPicker.is(":visible") ? "Hide": "Show"),
            !1
        },
        b.prototype.onPublishClick = function(a) {
            var b,
            c;
            return c = this.basicSelected ? this.basicTheme: this.theme(),
            b = [$(a.target).attr("href"), $.param(c.params("page"))],
            $(a.target).attr("href", b.join("&")),
            !0
        },
        b.prototype.selectedThemeIndex = function() {
            return this.themes.indexOf(this.selectedTheme)
        },
        b.prototype.prevTheme = function() {
            var a;
            return a = (this.selectedThemeIndex() - 1) % this.themes.length,
            a < 0 && (a += this.themes.length),
            this.themes[a]
        },
        b.prototype.nextTheme = function() {
            return this.themes[(this.selectedThemeIndex() + 1) % this.themes.length]
        },
        b.prototype.themeForLink = function(a) {
            return this.themes[this.themeLinks.index($(a))]
        },
        b.prototype.linkForTheme = function(a) {
            return $(this.themeLinks[this.themes.indexOf(a)])
        },
        b.prototype.scrollToTheme = function(a, b) {
            var c,
            d,
            e,
            f,
            ...
            h;
            b == null && (b = !0),
            c = this.linkForTheme(a),
            h = this.themes.indexOf(a),
            f = c.parent().outerWidth(!0),
            e = h * f,
            d = this.themeLinksContainer.scrollLeft(),
            g = d + this.themeLinksContainer.outerWidth(!0);
            if (e < d || e + f > g) return b ? this.themeLinksContainer.animate({
                scrollLeft: e
            },
            500) : this.themeLinksContainer.scrollLeft(e)
        },
        b.prototype.theme = function(a) {
            return a == null && (a = null),
            a ? (this.selectedTheme = a, this.showPreviewFor(a), this.themeLinks.removeClass("selected"), this.linkForTheme(a).addClass("selected"), this.scrollToTheme(a), this.miniPicker.find("span.name > strong").text(a.name)) : this.selectedTheme
        },
        b.prototype.color = function(a) {
            return a == null && (a = null),
            a ? (this.basicTheme.color = a, this.showPreviewFor(this.basicTheme), this.colorLinks.removeClass("selected"), this.linksForColor(a).addClass("selected")) : this.basicTheme.color
        },
        b.prototype.linksForColor = function(a) {
            return $(this.colorLinks.filter('a[data-theme-color="' + a + '"]'))
        },
        b.prototype.font = function(a) {
            return a == null && (a = null),
            a ? (this.basicTheme.font = a, this.showPreviewFor(this.basicTheme)) : this.basicTheme.font
        },
        b.prototype.showPreviewFor = function(a) {
            return $("#page-preview").attr("src", a.previewSrc())
        },
        b
    } (),
    $(function() {
        return new GitHub.ThemePicker
    })
}.call(this),
$(function() {
...
function() {
    ...
    GitHub.ParticipationGraph = function() {
        ...
        b.prototype.drawCommits = function(a, b) {
            ...
            j,
            k;
            d = this.el.getContext("2d"),
            f = 0;
            for (j = 0, k = a.length; j < k; j++) c = a[j],
            g = this.barWidth,
            e = c * this.scale,
            h = f * (this.barWidth + 1),
            i = this.barMaxHeight - e,
            this.canvas.fillStyle = b,
            this.canvas.fillRect(h, i, g, e),
            f++
        },
        b
    } (),
    $(document).pageUpdate(function() {
        return $(this).find(".participation-graph").each(function() {
            if ($(this).is(":hidden")) return $(this).removeClass("disabled"),
...
$(function() {
    ...
    e = function(b) {
        ...
        b.addClass("selected"),
        a.addClass("selected"),
        c.val(newPlan.attr("data-name")),
        newPlan.attr("data-cost") == 0 ? d.hide() : d.show()
    };
    a.find(".choose_plan").click(function() {
        return e($(this).closest("tr")),
        !1
    }),
    $(".selected .choose_plan").click()
}),
...
$(function() {
    ...
    $("dl.form.autocheck").each(function() {
        ...
        a.find("input").blur(function() {
            ...
            b.css("background-image", 'url("/images/modules/ajax/indicator.gif")'),
            $.ajax({
                type: "POST",
                ...
                success: function() {
                    b.next().is(".note") && b.next().find("strong").text(b.val()),
                    a.unErrorify(),
                    b.css("background-image", 'url("/images/modules/ajax/success.png")')
                },
                error: function(c) {
                    a.errorify(c.responseText),
                    b.css("background-image", 'url("/images/modules/ajax/error.png")')
                }
            })
        })
    })
...
$(function() {
    ...
    $.cookie("spy_repo", b.substr(1), a),
    $.cookie("spy_repo_at", new Date, a)
}),
function() {
    var a;
    GitHub.Stats = function() {
        ...
        a.prototype.timing = function(a, b) {
            if (b < 0) return;
            return this.namespace && (a = "" + this.namespace + "." + a),
            this.stats.push({
                metric: a,
                type: "timing",
                ms: b
        ...
        a.prototype.queueFlush = function() {
            var a = this;
            return this.flushTimer && clearTimeout(this.flushTimer),
        ...
        a.prototype.flush = function() {
            ...
            b;
            a = $(document.body);
            if (this.stats.length && a.hasClass("env-production") && !a.hasClass("enterprise")) return b = this.stats,
            this.stats = [],
            $.ajax({
                url: "/_stats",
                type: "POST",
    ...
    a = GitHub.stats = new GitHub.Stats("github.browser"),
    typeof window != "undefined" && window !== null && (window.$stats = a);
    if (typeof $ == "undefined" || $ === null) return;
    window.performance || $(window).bind("unload",
    function() {
    ...
    $(function() {
        var b,
        c;
        if (window.performance) return b = window.performance.timing,
        b.navigationStart && a.timing("performance.navigation", (new Date).getTime() - b.navigationStart),
        b.secureConnectionStart && b.connectStart && a.timing("performance.ssl", b.secureConnectionStart - b.connectStart),
        b.connectEnd && b.connectStart && (b.secureConnectionStart ? a.timing("performance.tcp", b.connectEnd - b.secureConnectionStart) : a.timing("performance.tcp", b.connectEnd - b.connectStart)),
        b.domainLookupStart !== b.domainLookupEnd && a.timing("performance.dns", b.domainLookupEnd - b.domainLookupStart),
        b.requestStart && b.responseStart && b.responseEnd && (a.timing("performance.request", b.responseStart - b.requestStart), a.timing("performance.response", b.responseEnd - b.responseStart)),
        $(window).bind("load",
        function() {
            b.domContentLoadedEventEnd && b.domLoading && a.timing("performance.DOMContentLoaded", b.domContentLoadedEventEnd - b.domLoading),
            b.domComplete && b.domLoading && a.timing("performance.load", b.domComplete - b.domLoading);
        ...
        if (window.name && window.name.match(/^\d+$/)) {
            try {
                c = JSON.parse(window.name),
                a.timing("pageload", (new Date).getTime() - c)
            } catch(d) {}
            return window.name = ""
        }
    })
...
$(function() {
    var a;
    if ($(".js-styleguide-ace")[0]) return a = new GitHub.CodeEditor(".js-styleguide-ace"),
    $(".js-styleguide-themes").change(function() {
...
GitHub.Team.prototype = {
    ...
    addRepo: function(a) {
        ...
        return b.find("a").attr("href", "/" + a).text(a),
        b.find(".remove-repository").attr("data-repo", a),
        GitHub.Autocomplete.visibilities[a] == "private" && b.addClass("private"),
        c.length > 0 && c.val(a).attr("disabled", !1),
        $(".repositories").append(b.show()),
        !0
    },
    ...
    removeRepo: function(a) {
        ...
        return this.newRecord() ? c() : (b.parent().find(".remove-repository").after('<img class="dingus spinner" src="/images/modules/ajax/indicator.gif"/>').hide(), this.removeRepoAjax(a, c, d)),
        !0
    },
    ...
    addUser: function(a) {
        ...
        return c && b.find("img").replaceWith(c),
...
$(function() {
    ...
    c.settings.selectFirst = !0,
    c.reposURL = a.orgUrl + "/autocomplete/repos",
    c.repos($(".add-repository-form input")).result(b),
    $(".remove-repository").live("click",
    function() {
        return a.removeRepo($(this).attr("data-repo")),
        !1
    }),
    $(".add-username-form input").userAutocomplete().result(b),
    ...
    $(".add-username-form button, .add-repository-form button").click(function() {
        ...
        !d || !c.data("completed") ? !1: (c.val("").removeClass("ac-accept"), a.addMember(d), !1)
    }),
    $(".add-username-form :text, .add-repository-form :text").keydown(function(a) {
        if (a.hotkey == "enter") return $(this).next("button").click(),
        !1;
        a.hotkey != "tab" && (debug("Clearing data.completed (was %s)", $(this).data("completed") || "null"), $(this).data("completed", null))
    })
}),
$(function() {
...
$(function() {
    function d(a, b) {
        ...
        b = b.split("?");
        var d = {};
        return b.length > 1 && (b = b[1].split("#"), b.length > 1 && (d.hash = b[1]), $.each(b[0].split("&"),
        function(a, b) {
            b = b.split("="),
            d[b[0]] = b[1]
        })),
...
function(a) {
    a.fn.commitishSelector = function(b) {
        var c = a.extend({},
        a.fn.commitishSelector.defaults, b);
        return this.each(function() {
            var b = a(this),
            ...
            c.bind("menu:deactivate",
            function() {
                r(),
                i.val(""),
                i.trigger("keyup")
            }),
            c.bind("menu:activated",
            function() {
                setTimeout(function() {
                    i.focus()
                },
...
$(function() {
    $(".subnav-bar").delegate(".js-commitish-button", "click",
    function(a) {
        a.preventDefault()
    }),
    $.hotkey("w",
    ...
    $(".pagehead .subnav-bar")[0] && $(".pagehead .subnav-bar a[data-name]").live("mousedown",
    function() {
...
GitHub.TreeFinder.prototype = {
    ...
    attachBehaviors: function() {
        ...
        function(a) {
            if (a.keyCode == 27) return ! slider.sliding && $("#slider .frame-center").is(".tree-finder") && (slider.slideBackTo(location.pathname), $(document).unbind("keydown.treeFinder")),
            !1
        }),
        a.currentFinder.on("navigation:open", "tr",
        function() {
            $(this).find("a").click()
        }),
        ...
        if (a.currentFinder && a.fileList) {
            ...
            a.currentFinder.find(".js-header").hide();
                ...
                for (f = 0; f < c.length; f++) {
                    ...
                    e += '<tr class="js-navigation-item"><td class="icon"><img src="/images/icons/txt.png"></td><td><a class="js-slide-to js-rewrite-sha" href="' + j + '">' + g + "</a></td></tr>"
                }
                d[0].innerHTML = e,
                $(d).trigger("pageUpdate"),
    ...
    loadFrame: function(a, b) {
        ...
        $.ajax({
            ...
            success: function(d) {
                b.call(this, d),
                $("#slider").trigger("slid"),
                $("#slider .breadcrumb").hide().last().after($(d).find(".breadcrumb")),
                $("#slider .breadcrumb").trigger("pageUpdate");
                var e = c.frameForURL(a);
                e.trigger("pageUpdate"),
                GitHub.CachedCommitDataPoller(50, e),
                GitHub.Blob.show(),
                c.setFrameTitle(e),
                c.setFrameCanonicalURL(e)
            },
            error: function() {
...
$(function() {
    ...
    $("#inline_visible_repos").click(function() {
        ...
        return $(".projects").load(b,
        function() {
            a.stopSpin(),
            $(".repositories").trigger("pageUpdate")
        }),
        a.hide(),
        !1
    }),
    ...
    $("#facebox .rename-warning button").live("click",
    function() {
